		...
		if(cmd.getName().equalsIgnoreCase("report")) {
			...
			case "read":
				...
				if(player.hasPermission("report.read")) {
					...
					if(args.length == 2) {
						...
						if(main.getConfig().contains("Report." + args[1])) {
							...
							player.sendMessage(ChatColor.RED + "Sorry, that report number doesn't exist");
							player.sendMessage(ChatColor.RED + "Do /report list to see the list of reports");
			...
			case "help":
				...
				if(player.hasPermission("report.help.admin")) {
					...
					player.sendMessage(ChatColor.YELLOW + "/report archvie [Number]: " + ChatColor.WHITE + "Archive a report");
				...
				if(player.hasPermission("archive.read")) {
					...
					if(args.length == 2) {
						...
						if(main.getConfig().contains("Archived." + args[1])) {
							...
							player.sendMessage(ChatColor.RED + "Sorry, that report number doesn't exist");
							player.sendMessage(ChatColor.RED + "Do /archive list to see the list of reports");							
